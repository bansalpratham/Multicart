...
const [loading,setLoading] = useState(false)
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-900 via-black to-gray-900 text-white px-4 pt-24 pb-10'>
      ...
      className='max-w-3xl mx-auto bg-white/10 backdrop-blur-md p-6 sm:p-10 rounded-2xl border border-white/20 '>

        <div className='flex flex-col items-center text-center'>
          <motion.div 
            whileHover={{scale : 1.05}}
          className='w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden border-2 border-white/30 hover:border-blue-400 bg-gray-700 '>
        ...
        <div className='grid grid-cols-1 gap-4 mt-8'>
          ...
          {showEditProfile && (
            ...
            <div className='flex flex-col items-center mb-6'>
              <motion.div 
              whileHover={{scale: 1.05}}
              className='w-24 h-24 rounded-full overflow-hidden border border-white/30 hover:border-blue-400 mb-3 bg-gray-700'>
