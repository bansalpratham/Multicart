        ...
        <div className='min-h-screen flex items-center justify-center bg-linear-to-br from-gray-900 via-black to-gray-900 text-white p-6'>
            <AnimatePresence>
                ...
                >
                    ...
                    <h1 className='text-2xl font-semibold text-center mb-6 text-gray-100'>Welcome Back to <span className='text-blue-400'>MultiCart</span></h1>
                    ...
                    <form onSubmit={handleSignIn} className='flex flex-col gap-4' >
                        ...
                        <button
                            ...
                            className='absolute right-12 top-45 -translate-1/2 text-gray-400 hover:text-white transition'>
                        ...
                        <p className='text-center text-sm mt-4 text-gray-400'>
                            ...
                            <span onClick={() => router.push("/api/register")} className='text-blue-400 hover:underline hover:text-blue-300 transition'>SignUp</span>
                        </p>
