...
function viewProduct() {
    ...
    <div className='min-h-screen bg-linear-to-br from-gray-900 via-black to-gray-900 px-4 py-10'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
            ...
            <div className='flex flex-col lg:flex-row gap-4'>
                ...
                {/* main image */}
                <div className='relative w-full lg:w-112.5 h-105 bg-white rounded-lg overflow-hidden flex items-center justify-center border border-white/10'>
       ...
       {product && <div className='mt-10 bg-white/5 border border-white/10 rounded-2xl p-6'>
        ...
        <div className='space-y-2 mb-6 text-gray-300'>
             ...
             {product.warranty && product.warranty !== "No Warranty"  && <p>
  ...
  <div className='mt-16 bg-white/5 border border-white/10 rounded-2xl p-6'>
      ...
      <div className='mb-8'>
          ...
          <div className='flex flex-col'>
              ...
              <input
                  ...
                  className='mb-3 text-white file:bg-blue-600 file:text-white file:px-3 file:py-1 file:rounded file:border-0 cursor-pointer'
              />
              ...
              className='bg-blue-600 hover:bg-blue-700 px-6 py-2 rounded text-white mt-4 font-semibold'
              >
      ...
      {product?.reviews && product.reviews.length > 0 ? (<h2 className='text-white font-semibold mb-2 text-2xl'>All Reviews</h2>
        ...
        {product?.reviews && product.reviews.length > 0 && (
                product?.reviews?.map((r,i)=>(
                   <div key={i} className='bg-white border w-62.5 border-black/10 rounded-xl p-5' >

                    <div className='flex items-center gap-3 mb-2'>
                        <div className='w-10 h-10 rounded-full border border-white/20 flex items-center justify-center bg-black'>
                            {r.user.image ? (<Image src={r.user.image} alt={r.user.name || "User"} width={35} height={35} className='w-9 h-9 rounded-full object-cover' />) : (<FaUserCircle className='w-8 h-8' />)}
                        </div>
                    ...
                    { r.image ? <div className='w-45 h-45 border border-white/10 rounded-lg overflow-hidden bg-black'>
                        <Image  src={r.image}
                            alt='Review Image'
                            width={180}
                            height={180}
                    ...
                    <div className='w-45 h-45 border border-white/10 rounded-lg overflow-hidden bg-gray-400 flex items-center justify-center text-white text-xs'>
                        No Review Image
                    </div>
                    }
