                ...
                >
                  ...
                  <td className='p-4 text-center text-xs'>
                    <button
                      ...
                      className='px-4 py-1 rounded-md bg-blue-600 hover:bg-blue-700 text-nowrap text-xs'
                    >
                      Vendor Products
                    </button>
                  </td>
        ...
        {selectedVendor && (
          ...
          >
            ...
            >
              ...
              {Array.isArray(allProductsData) && allProductsData.filter(
                (p: any) =>
                  String(
                    typeof p.vendor === "object"
                      ? p.vendor?._id
                      : p.vendor
                  ) === String(selectedVendor._id)
              ).length > 0 ? (
