...
import slide2 from "../../assets/slider1.webp";
import slide3 from "../../assets/slider2.jpg";
...
function Slider() {
 ...
 <div className='relative w-full min-h-[90vh] mt-0 overflow-hidden bg-black text-white md:mt-15 pt-0 top-0'>
    ...
    <Image src={slides[current].image} alt={slides[current].title} className='object-cover opacity-70' fill />
