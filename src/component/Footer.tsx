  ...
  <div className='bg-linear-to-br from-[#1f1f1f] to-[#0f0f0f] w-full text-gray-300 z-40 py-12 border-t border-gray-700'>
           ...
           <div className={`max-w-7xl mx-auto px-6 grid gap-10 text-center md:text-left ${isUser ? "grid-cols-1 sm:grid-cols-2 lg:grid-cols-4" : "grid-cols-1 md:grid-cols-3"}`}>
                    ...
                    <div className='space-y-3'>
                                <h2 className='text-white text-3xl font-bold cursor-pointer tracking-wide hover:text-blue-400 transition'>MultiCart</h2>
                                <p className='text-sm leading-relaxed text-gray-400'>Smart , secure & scalable multi-vendor eCommerce platform built for performance and growth.</p>
